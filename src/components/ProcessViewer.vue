  ...
  methods: {
    ...
    onSelectElement(element) {
      ...
      if (
        ...
        this.processNodeInfo.finishedTaskSet == null
      )
        return

      if (
        element == null ||
        this.processNodeInfo.finishedTaskSet.indexOf(element.id) === -1
      ) {
        return
      }
      ...
      console.log(this.taskCommentList)
    ...
    setProcessStatus(processNodeInfo) {
      ...
      if (
        ...
        return
      const { finishedSequenceFlowSet, finishedTaskSet, unfinishedTaskSet } =
