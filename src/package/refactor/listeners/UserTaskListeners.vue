<template>
  <div class="panel-tab__content">
    ...
    >
      ...
      >
        ...
        <template v-if="listenerForm.event === 'timeout'">
          ...
          >
            <el-input
              v-model="listenerForm.eventTimeDefinitions"
              clearable
            />
          </el-form-item>
        </template>
      ...
      <p class="listener-filed__title">
        <span><i class="el-icon-menu" />注入字段：</span>
        <el-button
          type="primary"
    ...
    >
      ...
      <template $footer>
        <el-button @click="listenerFieldFormModelVisible = false">
          取 消
        </el-button>
        <el-button
          type="primary"
